  ...
  return (
    <ScrollView style={{ flex: 1, }}>
      <View style={{ alignItems: "center", display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        {/* BEST SELLERS CARDS  */}
        <View style={{ width: "90%", display: "flex", flexDirection: "column", alignItems: "center", rowGap: 1, paddingHorizontal: 12 }}>
          <Text style={{ fontSize: 20, fontWeight: "800", height: 40, width: "100%", textAlign: "center" }}>Best Sellers</Text>
          {cardsHome.map((card) => (
            <View key={card._id}>
              ...
              <TouchableOpacity
                ...
                <View style={{ display: "flex", width: 150, height: "100%", paddingVertical: 30, alignItems: "flex-start", justifyContent: "center" }}>
                  <Text style={{ fontSize: 16 }}>{card.name}</Text>
                  <Text style={{ color: "purple", fontSize: 17 }}>$ {card.price}</Text>
                </View>
        ...
        <View style={{ width: "90%", backgroundColor: "white", display: "flex", flexDirection: "column", gap: 12, alignItems: "center", padding: 12 }}>
          ...
          {categoriesHome.map((cat) => (
            <View key={cat._id} style={{ width: 320, height: 150, backgroundColor: "transparent", justifyContent: "center", alignItems: "center" }}>
              <TouchableOpacity style={{ width: "100%", height: "70%", display:"flex" , flexDirection:"row" }}
              ...
              <View style={{ display: "flex", justifyContent: "space-evenly", alignItems: "center" }}>
                <Text style={{ fontSize: 20, width: 150 }}>{cat.name}</Text>
              </View>
              </TouchableOpacity>
            </View>
          ))}
